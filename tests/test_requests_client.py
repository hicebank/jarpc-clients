...
from jarpc_clients import RequestsTransport, create_requests_client
...
class TestRequestsClient:
    ...
    def test_call(self):
        ...
        response = json.dumps({'result': expected_result, 'request_id': 'some_id', 'id': 'some_id'})

        with mock.patch('jarpc_clients.requests_client.requests.Session') as SessionMock:
