...
def create_requests_client(url: str,
                           session=None,
                           request_kwargs: Optional[dict] = None,
                           ...
                           dumps: Callable[[Any], str] = jarpc.format.json_dumps) -> jarpc.JarpcClient:
    """
    ...
    """
    transport = RequestsTransport(url=url, session=session, request_kwargs=request_kwargs)
    return jarpc.JarpcClient(transport=transport, default_ttl=default_ttl, default_rpc_ttl=default_rpc_ttl,
